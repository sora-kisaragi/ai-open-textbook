...
| [docs/ANSWER_RUBRIC_VERSIONING.md](../ANSWER_RUBRIC_VERSIONING.md) | #17; supports #8 | `draft`; `needs_human_review` | Confirm answer/rubric versioning expectations, supersession handling, and revision-record triggers. | Yes | Use confirmed rules before changing answer or rubric records. |
